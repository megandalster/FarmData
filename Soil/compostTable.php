...
<?php
   ...
   echo "</table>";
   echo "<form name='accumulationForm' method='POST' action='/farmdata/down.php'>";
...
<?php
   ...
   echo "</table>";
   echo "<form name='activityForm' method='POST' action='/farmdata/down.php'>";
...
<?php
   ...
   echo "</table>";
   echo "<form name='temperatureForm' method='POST' action='/farmdata/down.php'>";
...
<?php
   ...
   echo "</table>";
   echo "<form name='applicationForm' method='POST' action='/farmdata/down.php'>";
