 ...
 */
	...
	echo '<link type="text/css" href="/farmdata/tabs.css" rel = "stylesheet">';
 /*
   echo '<link type="text/css" href="/farmdata/tableDesign.css" rel = "stylesheet">';
...
<ul>
   <li id="li_harvest"><a href="/farmdata/design.php?tab=harvest" id = "harvest_a" class = "inactivetab">Harvest</a></li>
   <li id="li_seeding"><a class = "inactivetab" href="/farmdata/design.php?tab=seeding" id= "seeding_a">Seed</a></li>
<?php
if ($_SESSION['soil']) {
echo '<li id="li_soil"><a href="/farmdata/design.php?tab=soil" class = "inactivetab" id= "soil_a">Soil</a></li>';
}
if ($_SESSION['notes']) {
   echo '<li id="li_notes"><a href="/farmdata/design.php?tab=notes" class = "inactivetab" id= "notes_a">Comments</a></li>';
}
if ($_SESSION['labor']) {
   echo '<li id="li_labor"><a href="/farmdata/design.php?tab=labor" class = "inactivetab" id= "labor_a">Labor</a></li>';
}
if ($_SESSION['admin']==1) {
   echo '<li id="li_admin"><a href="/farmdata/design.php?tab=admin" class = "inactivetab" id ="admin_a">Admin</a></li>';
}
?>
   <li id="li_logout"><a href="/farmdata/logout.php" class = "inactivetab" id= "logout_a">Logout</a></li>
</ul>
